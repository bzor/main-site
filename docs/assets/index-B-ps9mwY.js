...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        `,transparent:!0});Et=new zt(o,a),Ls.add(Et),Fo(),window.addEventListener("resize",vp,!1),cr=new Ie(ut.backgroundColor),ur=new Ie(ut.textColor),hr=new Ie(ut.highlightColor),dr=new Ie(ut.backgroundColor),fr=new Ie(ut.textColor),pr=new Ie(ut.highlightColor),Dt=new Ie,Oo(0),No(),Io=!0}function No(){requestAnimationFrame(No),Qn.render(Ls,hn)}function vp(){hn.aspect=window.innerWidth/window.innerHeight,hn.updateProjectionMatrix(),Qn.setSize(window.innerWidth,window.innerHeight),Fo()}function Fo(){const i=2*Math.tan(hn.fov*Math.PI/180/2)*hn.position.z,e=i*hn.aspect,t=16/9;let n,r;e/i>t?(r=e/t,n=e):(n=i*t,r=i),Et.scale.set(n/16,r/9,1)}function xp(i){Et.material.uniforms.inTex.value=i,Et.material.needsUpdate=!0}function Mp(i){Zr=i;let e=null,t=null,n,r=0;for(let s=0;s<Zr.length;s++)n=Zr[s],n.progress==1?e=n:n.progress>0&&(t=n,r=n.progress);e!=null&&e!==$n&&($n=e,cr.set($n.palette.backgroundColor),ur.set($n.palette.textColor),hr.set($n.palette.highlightColor),Sp($n)),t!=null&&t!==Zn&&(Zn=t,dr.set(Zn.palette.backgroundColor),fr.set(Zn.palette.textColor),pr.set(Zn.palette.highlightColor),Ep(Zn)),e==null&&(Et.material.uniforms.mainTex.value=null),e==null&&t==null&&(cr.set(ut.backgroundColor),ur.set(ut.textColor),hr.set(ut.highlightColor),dr.set(ut.backgroundColor),fr.set(ut.textColor),pr.set(ut.highlightColor)),t==null?Et.material.uniforms.inT.value=0:Et.material.uniforms.inT.value=r,Oo(r),Et.material.needsUpdate=!0}function ja(i){Ws=i}function Sp(i){const e=i.imageName,t=Ws.find(n=>n.imageName===e);t&&t.texture&&(Et.material.uniforms.mainTex.value=t.texture,Et.material.needsUpdate=!0)}function Ep(i){const e=i.imageName,t=Ws.find(n=>n.imageName===e);t&&t.texture&&(Et.material.uniforms.inTex.value=t.texture,Et.material.needsUpdate=!0)}function Oo(i){Io&&(i=Cs.smoothstep(i,.4,.6),Dt.set(cr.getHex()),Dt.lerp(dr,i),document.documentElement.style.setProperty("--background-color",`#${Dt.getHexString()}`),Dt.set(ur.getHex()),Dt.lerp(fr,i),document.documentElement.style.setProperty("--text-color",`#${Dt.getHexString()}`),Dt.set(hr.getHex()),Dt.lerp(pr,i),document.documentElement.style.setProperty("--highlight-color",`#${Dt.getHexString()}`),Bo(`#${Dt.getHexString()}`))}function Bo(i){document.querySelector("feFlood").setAttribute("flood-color",i)}function yp(){return fetch("./contentData.json").then(i=>{if(!i.ok)throw new Error("Network response was not ok "+i.statusText);return i.json()})}function Tp(i,e){const t=i.map(a=>a.heroImage),n=new Uo,r=[];let s=0,o=document.querySelector(".loader-bar");t.forEach(a=>{n.load(a,l=>{let c=a.split("/").pop();c=="syncopated.jpg"&&xp(l),r.push({imageName:c,texture:l}),s++,gsap.to(o,{duration:1,width:`${s/t.length*100}%`,ease:"power1.inOut",overwrite:!0}),s===t.length&&(gsap.to(o,{top:-10,ease:"none",duration:.4,delay:1,onComplete:e}),ja(r))},void 0,l=>{console.error(`Failed to load image: ${a}`,l),s++,s===t.length&&(ja(r),e())})})}function Ap(i){const e=document.getElementById("smooth-content");i.forEach((t,n)=>{t.textActive=0;const r=document.createElement("div");r.className="text-container",r.id=`text-container-${n}`;const s=document.createElement("div");s.className="content-detail-left";const o=document.createElement("div");o.className="content-detail";const a=document.createElement("span");a.className="content-label",a.innerHTML=`<span class="content-label-detail">|</span>0${n+1}`;const l=document.createElement("span");l.className="content-line",o.appendChild(a),o.appendChild(l);const c=document.createElement("div");c.className="content-text";const u=document.createElement("h2");u.className="content-title",u.textContent=t.title;const f=document.createElement("p");f.className="content-description",f.innerHTML="";const d=document.createElement("p");d.className="content-tag",d.innerHTML=t.tag;const m=document.createElement("p");m.className="content-platform",m.innerHTML=`PLATFORM: ${t.platform}`;const _=document.createElement("p");_.className="content-status",_.innerHTML=`STATUS: ${t.status}`;const M=document.createElement("div");M.className="content-text-detail";const p=document.createElement("div");p.className="content-text-detail-left";const h=document.createElement("div");h.className="content-text-detail-right",c.appendChild(u),c.appendChild(m),c.appendChild(_),c.appendChild(f),c.appendChild(d),c.appendChild(M),c.appendChild(p),c.appendChild(h),r.appendChild(s),r.appendChild(o),r.appendChild(c);const T=document.createElement("div");T.className="images-container",T.id=`images-container-${n}`;const S=document.createElement("div");S.className="image-placeholder",S.dataset.imageName=t.heroImage.split("/").pop(),T.appendChild(S);const A=document.createElement("div");A.className="text-show",A.id=`text-show-${n}`;const B=document.createElement("div");B.className="end-spacer",B.id=`end-spacer-${n}`,e.appendChild(r),e.appendChild(T),e.appendChild(A),e.appendChild(B)})}function bp(i){ScrollTrigger.refresh();const e=[];i.forEach((t,n)=>{const r=document.getElementById(`text-container-${n}`),s=r.querySelector(".content-label"),o=r.querySelector(".content-line"),a=r.querySelector(".content-title");r.querySelector(".content-detail-left");const l=r.querySelector(".content-platform"),c=r.querySelector(".content-status"),u=r.querySelector(".content-description"),f=document.querySelectorAll(`#images-container-${n} .image-placeholder`),d=document.querySelectorAll(`#text-show-${n}`),m=r.querySelectorAll(".content-text-detail");document.querySelectorAll(`#end-spacer-${n}`),gsap.timeline({scrollTrigger:{trigger:r,start:"top bottom-=100px",end:"bottom bottom",onEnter:()=>{gsap.to(s,{autoAlpha:1,duration:.5}),gsap.to(o,{scaleX:1,duration:.5,transformOrigin:"left",ease:"power4.out"}),gsap.to(a,{autoAlpha:1,y:0,duration:1,ease:"power4.inOut"}),gsap.to(l,{autoAlpha:1,y:0,duration:1,ease:"power4.inOut"}),gsap.to(c,{autoAlpha:1,y:0,duration:1,ease:"power4.inOut"}),gsap.to(u,{autoAlpha:1,y:0,duration:1,ease:"power4.inOut"})},markers:!1}}),gsap.timeline({scrollTrigger:{trigger:r,start:"top 80px",end:"+=175%",pin:!0,pinSpacing:!1,markers:!1}}),gsap.timeline({scrollTrigger:{trigger:r,start:"top bottom",end:"top 100px",scrub:!0,snap:{snapTo:1,directional:!1,delay:1,duration:3,ease:"sine.inOut"},onUpdate:_=>{const M=_.progress;f.forEach(p=>{const h=p.dataset.imageName,T={imageName:h,palette:t.palette,progress:M},S=e.findIndex(A=>A.imageName===h);S>-1?e[S]=T:e.push(T)}),Mp(e)},markers:!1}}),gsap.timeline({scrollTrigger:{trigger:d,start:"top 40%",end:"top 80px",toggleActions:"play none none reverse"}}).to(t,{duration:.5,ease:"none",textActive:1,onUpdate:()=>{const _=["/","|","\\","-","_"],M=Cs.smoothstep(t.textActive,0,.7),p=Cs.smoothstep(t.textActive,.3,1),h=Math.floor(M*t.description.length),T=Math.floor(p*t.description.length);let S="";S=t.description.substr(0,Math.floor(t.description.length*p));for(let A=T;A<h;A++)S+=_[Math.floor(A+t.textActive*_.length*50)%_.length],Math.random()<.05&&(S+=" ");u.innerHTML=S}}).to(u,{duration:.5,ease:"sine.inOut",paddingBottom:10},0),gsap.timeline({scrollTrigger:{trigger:d,start:"top bottom",end:"top 40%",scrub:!0}}).to(m,{ease:"none",width:"100%"}),n!=i.length-1&&gsap.timeline({scrollTrigger:{trigger:d,start:"top 35%",end:"bottom top",scrub:!0,onUpdate:_=>{console.log(_.progress)}}}).to(m,{ease:"none",left:"100%",width:"0%"})})}const mr=document.getElementById("nav-tracker"),Ja=document.querySelector(".scroll-indicator");let ji=!1;function wp(){const i=document.querySelectorAll("#logo-block, #bio, .text-container"),e=document.querySelector(".nav-progress"),t=document.body.getBoundingClientRect().height-window.innerHeight;let n=[];gsap.set(mr,{top:-10});let r=0,s,o;for(let u=0;u<i.length;u++){u<i.length-1?(s=i[u+1],o=s.getBoundingClientRect().y):o=t;const f=(o-r)/t*100;r=o,n.push(f)}let a=0;i.forEach((u,f)=>{const d=document.createElement("div");d.classList.add("nav-section"),d.style.width=`${n[f]}%`,d.style.left=`${a}%`;const m=document.createElement("div");m.classList.add("nav-section-inner"),a+=n[f],mr.appendChild(d),d.appendChild(m)});function l(){e.style.left=`calc(${c.progress*100}% - 1px)`,c.progress<.003&&ji&&(ji=!1,gsap.to(Ja,{duration:.4,autoAlpha:1,ease:"power3.inOut"})),c.progress>=.003&&!ji&&(ji=!0,gsap.to(Ja,{duration:.4,autoAlpha:0,ease:"power3.inOut"}))}const c=ScrollTrigger.create({trigger:document.body,start:"top top",end:"bottom bottom",onUpdate:l})}function Rp(){gsap.to(mr,{duration:.2,autoAlpha:1,ease:"power1.out"}),gsap.to(mr,{duration:.6,top:0,ease:"power3.inOut"})}_p("threejs-container");gsap.registerPlugin(ScrollTrigger,ScrollSmoother);function Cp(){const i=document.documentElement;i.style.setProperty("--background-color",ut.backgroundColor),i.style.setProperty("--text-color",ut.textColor),i.style.setProperty("--highlight-color",ut.highlightColor)}Cp();function Pp(){ScrollTrigger.refresh()}yp().then(i=>{Tp(i,()=>{document.getElementById("smooth-content").style.display="block",Ap(i),bp(i),wp(),Rp(),gsap.to(".bio-line",{duration:.8,scaleX:1,delay:.5,ease:"power4.inOut"}),gsap.to(".bio-title",{duration:1.2,autoAlpha:1,delay:1.3,ease:"power4.out"}),gsap.to(".bio-text-content",{duration:1.2,autoAlpha:1,delay:1.4,ease:"power4.out"}),gsap.to(".bio-bottom-detail",{duration:1.2,scaleX:1,delay:1.5,ease:"power4.out",onComplete:Pp}),gsap.to(".bio-loading",{duration:.2,autoAlpha:0,delay:.8,ease:"power1.in"}),gsap.to(".bio-greeting",{duration:.2,autoAlpha:1,delay:1,ease:"power1.out"})})}).catch(i=>console.error("Error fetching content data:",i));gsap.matchMedia();ScrollSmoother.create({smooth:1,effects:!0,normalizeScroll:!0,smoothTouch:!0,ignoreMobileResize:!0});
